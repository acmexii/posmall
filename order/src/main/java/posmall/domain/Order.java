...
import lombok.Data;
import posmall.OrderApplication;
import posmall.domain.OrderPlaced;
...
public class Order {
    ...
    public static void updateStatus(DeliveryCompleted deliveryCompleted) {
        ...
        */
        ...
        // if deliveryCompleted.cjLogisId exists, use it
        
        // ObjectMapper mapper = new ObjectMapper();
        // Map<, Object> deliveryMap = mapper.convertValue(deliveryCompleted.getCjLogisId(), Map.class);
